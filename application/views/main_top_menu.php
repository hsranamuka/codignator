...
// Validating Empty Field  
    ...
    <div class="wrapper">
        ...
        <header class="main-header"> <a href="<?php echo base_url() ?>index.php/dashboard" class="logo"><b>Codignator Testing</b></a> 
            ...
            <nav class="navbar navbar-static-top" role="navigation"> 
                ...
                <div class="navbar-custom-menu">
                    ...
                    <p>
                 		...
                 		Vidarshana Institute

                      <small><b><?php echo $this->session->userdata('name')  ?></b></small>
